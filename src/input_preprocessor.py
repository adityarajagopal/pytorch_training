...
class Preproc(object):
    ...
    def create_subclass_dataset(self, dataset, data_loc, coarse_classes=[]) : 
        if dataset == 'cifar100' : 
            ...
            train_indices = self.extract_subclasses(Y_labels, train_coarse_Y)
            test_indices = self.extract_subclasses(Y_labels, test_coarse_Y)
