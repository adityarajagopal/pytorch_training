...
class Application(object):
    ...
    def run_training(self):
        ...
        self.trainer.train_network(self.params, self.tbx_writer, self.checkpointer, self.train_loader, self.test_loader, self.model, self.criterion, self.optimiser, self.inferer) 
    ...
    def setup_dataset(self):
        ...
        self.train_loader, self.test_loader = self.preproc.import_and_preprocess_dataset(self.params) 
